  ...
  return (
    <section className="container-page py-10 sm:py-14">
      <article className="card relative overflow-hidden">
        ...
        <p className="mt-4 text-center text-[15px] leading-[1.85] text-fg-muted">
          ...
          <span className="font-semibold text-fg">외향인 버전</span>으로 두 가지 방식이 개최되고,
          <br className="sm:hidden" />{" "}
          첫 파티는{" "}
