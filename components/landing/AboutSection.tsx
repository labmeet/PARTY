...
const BULLETS: {
...
}[] = [
  {
    ...
    body: (
      <>
        KAIST 구성원들이 만들어나가는 오프라인 파티. 소개팅 해달라고 하기도 기 빨리시나요? 세미나실에서 눈만 마주치던 그 사람, 눈길 가는 옆 랩 사람, 조용히 랩미에서 만나봐요!
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        저희가 알잘딱으로 자리 채워서 재미있게,
        <br className="sm:hidden" />{" "}
        <strong className="font-semibold text-fg">기 안 빨리게</strong> 자리를 만들어드려요.
        <br />
        대신 누가 올지는 알려드릴 수 없어요.
        <br />
        현장에서 직접 확인해주세요.
      </>
    ),
